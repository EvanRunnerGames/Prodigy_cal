...
while True:
    ...
    if _1to4.lower() == "radius" or _1to4.lower() == "r":
        radius =  input(Fore.WHITE + "What is the Radius: ")
    ...
    if _1to4.lower() == "diameter" or _1to4.lower() == "d":
        diameter =  input(Fore.WHITE + "What is the Diameter: ")
    ...
    if _1to4.lower() == "circumfrance" or _1to4.lower() == "c":
        circumfrance =  float(input(Fore.WHITE + "What is the Circumfrance: "))
    ...
    if _1to4.lower() == "area" or _1to4.lower() == "a":
        area =  float(input(Fore.WHITE + "What is the Area: "))
